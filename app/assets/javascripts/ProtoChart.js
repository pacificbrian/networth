...
*/
	...
	plotLineArea: function(data) {
        ...
        var bottom_floor_zero = Math.min(Math.max(0, this.yaxis.min), this.yaxis.max);
        /** P-BRIAN, modified bottom: **/
        var bottom = this.yaxis.min;
        var top, lastX = 0;
	...
	drawPieGraph: function(graphData)
	{
		var sumData = 0;
		var radius = 0;
		var centerX = this.chartWidth/2 - this.chartWidth/8;
