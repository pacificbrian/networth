...
ActiveRecord::Schema.define(:version => 20100318045503) do
  ...
  create_table "account_values", :force => true do |t|
    t.integer "account_id"
    t.date    "date"
    t.decimal "value"
  end
  ...
  create_table "backend_companies", :force => true do |t|
    t.integer "company_id"
    t.integer "backend_database_id"
    t.integer "backend_id"
  end

  create_table "backend_databases", :force => true do |t|
    t.string "name"
  end

  create_table "backend_types", :force => true do |t|
    t.string "name"
  end
  ...
  create_table "rule_conditions", :force => true do |t|
    t.string "name"
  end

  create_table "rule_operands", :force => true do |t|
  ...
  create_table "rules", :force => true do |t|
    t.string  "name"
    t.integer "user_id"
    t.integer "rule_condition_id"
    t.integer "rule_loperand_id"
    t.integer "rule_roperand_id"
    t.integer "weight"
    t.decimal "value"
  end
  ...
  create_table "screener_request", :force => true do |t|
    t.integer "user_id"
  end

  create_table "screener_requests", :force => true do |t|
    t.integer  "user_id"
    t.integer  "screener_id"
    t.datetime "created_on"
  end

  add_index "screener_requests", ["user_id"], :name => "index_screener_requests_on_user_id"

  create_table "screener_rules", :force => true do |t|
    t.integer "screener_id"
    t.integer "rule_id"
  end

  add_index "screener_rules", ["rule_id"], :name => "index_screener_rules_on_rule_id"
  add_index "screener_rules", ["screener_id"], :name => "index_screener_rules_on_screener_id"
  ...
  add_index "screeners", ["user_id"], :name => "index_screeners_on_user_id"
  ...
  add_index "security_values", ["security_id"], :name => "index_security_values_on_security_id"
